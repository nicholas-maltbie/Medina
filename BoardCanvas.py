...
class BoardCanvas(tkinter.Tk):
    def __init__(self, board):
        ...
        self.offset_values = [(0,0), (max_x + GRID_GAP + GRID_WIDTH // 2, 0), (0, max_y + GRID_GAP + GRID_HEIGHT // 2), 
                (max_x + GRID_GAP + GRID_WIDTH // 2, max_y + GRID_GAP + GRID_HEIGHT // 2)]
    ...
    def get_wall_pixels(self, wall, index):
        ...
        if wall == 'N':
            ...
            starting = (self.offset_values[0][0] + TOWER_SIZE + GRID_GAP + (GRID_WIDTH + GRID_GAP) // 2, 
                    self.offset_values[0][1] + TOWER_SIZE + GRID_GAP - WALL_WIDTH // 2)
        elif wall == 'S':
            wall_size = (GRID_WIDTH + GRID_GAP, 0)
            starting = (self.offset_values[2][0] + TOWER_SIZE + GRID_GAP + (GRID_WIDTH + GRID_GAP) // 2, 
                    self.offset_values[2][1] + TOWER_SIZE + GRID_GAP - WALL_WIDTH)
        elif wall == 'W':
            wall_size = (0, GRID_HEIGHT + GRID_GAP)
            starting = (self.offset_values[0][0] + TOWER_SIZE + GRID_GAP - WALL_WIDTH // 2, 
                    self.offset_values[0][1] + TOWER_SIZE + GRID_GAP + (GRID_HEIGHT + GRID_GAP) // 2)
        elif wall == 'E':
            wall_size = (0, GRID_HEIGHT + GRID_GAP)
            starting = (self.offset_values[1][0] + TOWER_SIZE + GRID_GAP - WALL_WIDTH, 
                    self.offset_values[1][1] + TOWER_SIZE + GRID_GAP + (GRID_HEIGHT + GRID_GAP) // 2)
    ...
    def get_tower_pixels(self, tower_number):
        ...
        offset = self.offset_values[tower_number - 1]
