...
class BaseGameSpec(object):
    ...
    def evaluate(self, board_state, side):
        """An evaluation function for this game, gives an estimate of how good the board position is for a given side.
    ...
    def tuple_move_to_flat(self, tuple_move, side):
